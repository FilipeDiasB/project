                                    ...
                                    <div class="property_image_item">
                                        ...
                                        <div class="property_image_actions">
                                            <a href="javascript:void(0)"
                                               ...
                                               data-action="{{ route('admin.properties.imageSetCover', ['image' => $image]) }}"></a>
                                            <a href="javascript:void(0)"
                                               class="btn btn-red btn-small icon-times icon-notext image-remove"
                                               data-action="{{ route('admin.properties.imageRemove', ['image' => $image]) }}"></a>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
        ...
        $(function () {
            ...
            $('.image-set-cover').click(function (event) {
                ...
                $.post(button.data('action'), {}, function (response) {
                    //marcar botao check como verdinho depende do controlador
